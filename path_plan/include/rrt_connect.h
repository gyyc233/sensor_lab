#ifndef PATH_PLAN_RRT_CONNECT_H
#define PATH_PLAN_RRT_CONNECT_H
...
private:
  ...
  vector<double> rand_area,
      play_area; //采样区域 x,y ∈ [min,max];约束随机树的范围
                 //[xmin,xmax,ymin,ymax]
...
public:
  ...
  generateFinalCourse(); //生成路径，与RRT不同的地方
