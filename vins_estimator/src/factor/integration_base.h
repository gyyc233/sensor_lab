#ifndef VINS_ESTIMATOR_FACTOR_INTEGRATION_BASH
#define VINS_ESTIMATOR_FACTOR_INTEGRATION_BASH
...
public:
  ...
  void midPointIntegration(
    ...
    result_delta_q =
        delta_q * Eigen::Quaterniond(1, un_gyr(0) * _dt / 2,
                                     un_gyr(1) * _dt / 2, un_gyr(2) * _dt / 2);
