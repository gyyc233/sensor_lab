#ifndef __H_SLAM_BOOK_BAL_PROBLEM_H__
#define __H_SLAM_BOOK_BAL_PROBLEM_H__

#include <string>

/// 从文件读入BAL dataset,  这里直接用高博的代码了
class SlamBookBALProblem {
public:
  /// load bal data from text file
  explicit SlamBookBALProblem(const std::string &filename,
