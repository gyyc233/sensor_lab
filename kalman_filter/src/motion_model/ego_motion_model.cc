...
Matrix<DIM_X, DIM_X>
EgoMotionModel::getProcessNoiseCov(Vector<DIM_X> const &vecX,
...
Matrix<DIM_X, DIM_X>
EgoMotionModel::getInputNoiseCov(Vector<DIM_X> const &vecX,
                                 Vector<DIM_U> const &vecU) const {
  ...
  u11 = (m_uDeltaDist * cos2Theta) +
        (m_uDeltaYaw * quarterDeltaDistSquare * sin2Theta);
  u12 = (m_uDeltaDist * sinCosTheta) -
        (m_uDeltaYaw * quarterDeltaDistSquare * sinCosTheta);
  u13 = -m_uDeltaYaw * halfDeltaDistSquare * sinTheta;

  u21 = (m_uDeltaDist * sinCosTheta) -
        (m_uDeltaYaw * quarterDeltaDistSquare * sinCosTheta);
  u22 = (m_uDeltaDist * sin2Theta) +
        (m_uDeltaYaw * quarterDeltaDistSquare * cos2Theta);
...
Matrix<DIM_X, DIM_X>
EgoMotionModel::getJacobianFk(Vector<DIM_X> const &vecX,
                              Vector<DIM_U> const &vecU) const {
...
Matrix<DIM_X, DIM_U>
EgoMotionModel::getJacobianBk(Vector<DIM_X> const &vecX,
                              Vector<DIM_U> const &vecU) const {
