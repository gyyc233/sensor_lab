#ifndef LIDAR_3D_LIO_PRE_INTEGRATION_H
#define LIDAR_3D_LIO_PRE_INTEGRATION_H
#ifdef ROS_CATKIN
...
public:
  ...
  LIO_PreIntegration(Options options = Options());

  ~LIO_PreIntegration() = default;
