#ifndef LIDAR_3D_IESKF_HPP
#define LIDAR_3D_IESKF_HPP
#ifdef ROS_CATKIN
...
public:
  ...
  /**
   * NDT观测函数，输入一个SE3 Pose, 返回两个类似jacobian矩阵的残差项
   * HT V^{-1} H
   * H^T V{-1} r
   * 二者都可以用求和的形式来做
   */
