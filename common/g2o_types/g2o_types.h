#ifndef COMMON_G2O_TYPES_H
#define COMMON_G2O_TYPES_H
...
public:
  ...
  /// @brief 顶点更新函数，用于优化过程中增量计算
  /// @param update_
  virtual void oplusImpl(const double *update_) {
    _estimate.so3() =
        _estimate.so3() * SO3::exp(Eigen::Map<const Vec3d>(
                              &update_[0])); // 旋转部分，李群矩阵更新
