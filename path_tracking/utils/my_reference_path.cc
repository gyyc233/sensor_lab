 ...
 * @return
 */
std::vector<double> MyReferencePath::calcTrackError(std::vector<double> robot_state) {
 ...
 */
refTraj MyReferencePath::calc_ref_trajectory(std::vector<double> robot_state,parameters param, double dl) {
    std::vector<double>track_error = calcTrackError(robot_state);//e,k,ref_yaw,ind
